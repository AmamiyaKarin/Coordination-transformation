// Seven-para-trans.cpp : 此文件包含 "main" 函数。程序执行将在此处开始并结束。
//
...
int main()
{
	...
	MatrixXd V2 = x1 - l2;
	Matrix<double, 3, 7>B3;
	Matrix<double, 3, 1>l3;
	B3 << 1, 0, 0, 0, -2894337.6030, 5496337.0138,-2100337.2849,
		0, 1, 0, 2894337.6030, 0, 2100337.2849,5496337.0138,
		0, 0, 1, -5496337.0138, -2100337.2849, 0,2894337.6030;
	...
	cout << "DK=" << Para(6, 0) << endl;
	cout << "验后单位权中误差=" << sqrt(sigma2(0, 0) / 5) << endl << endl;
